    ...
    render() {
        return (
            <div style={{position:'relative'}}>
                ...
                <input style={{width:'600px', margin:'5px', padding:'5px'}} type="text" value={this.state.movieValue} onChange={this.searchMovies} placeholder="Search The New York Times for Movie Reviews.. "/>
