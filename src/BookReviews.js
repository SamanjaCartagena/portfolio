    ...
    render() {
        return (
            <div style={{position:'relative'}}>
                ...
                <input style={{width:'600px', margin:'5px', padding:'5px'}} type="text" value={this.state.bookValue} onChange={this.searchBooks} placeholder="Search The New York Times for Book Reviews.. "/>
